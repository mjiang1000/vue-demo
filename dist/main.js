...
_vue2.default.use(_vuex2.default); // index.js
...
var store = new _vuex2.default.Store({
  ...
  actions: {
    FETCH_ITEMS: function FETCH_ITEMS(_ref, _ref2) {
      ...
      return (0, _api.getlist)(type, page).then(function (_ref3) {
        var data = _ref3.data;
  ...
  getters: {
    activeItems: function activeItems(state) {
...
function timeAgo(datestr) {
  ...
  var between = Date.now() / 1000 - d.getTime() / 1000;
  if (between < 3600) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("全部")])], 1), _vm._v(" "), _c('li', [_c('router-link', {
    attrs: {
      "to": "/good"
    }
  }, [_vm._v("精华")])], 1), _vm._v(" "), _c('li', [_c('router-link', {
    attrs: {
      "to": "/ask"
    }
  }, [_vm._v("问答")])], 1), _vm._v(" "), _c('li', [_c('router-link', {
    attrs: {
      "to": "/job"
    }
  }, [_vm._v("招聘")])], 1), _vm._v(" "), _c('li', [_c('router-link', {
    attrs: {
      "to": "/share"
    }
